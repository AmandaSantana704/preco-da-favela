...
<section class="container page-search">
    <form method="POST" action="{{route('app.search.store')}}" class="fixed-search">
      ...
      <div class="page-serach-result">
        <h1 class="mt-4 mb-3"><a href="{{ url()->previous() }}" class="ti-angle-left" style="color: #333333; font-size: 22px; position: relative; top:3px; padding-right:10px;"></a>Resultado da busca</h1>
        <section class="container store mt-5">
            ...
            <div class="row">
                    @foreach($searchcommerces as $commerce)
                    <div class="store-all-items mt-5 col-12 col-md-6">
