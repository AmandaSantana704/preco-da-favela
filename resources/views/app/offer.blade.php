...
<section class="container page-offer">
    <form method="POST" action="{{route('app.search.product.offer')}}" class="fixed-search">
      ...
      <div class="page-offer-result">
        <h1 class="mt-4 mb-4"><a href="{{ url()->previous() }}" class="ti-angle-left" style="color: #333333; font-size: 22px; position: relative; top:3px; padding-right:10px;"></a>Produtos em promoção</h1>
