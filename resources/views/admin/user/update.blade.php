...
@section('contain')
    ...
    <div class="col-7 align-self-center">
        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Atualização de usuário</h3>
                ...
                <form action="{{route('user.update', ['id'=>$user['id']])}}" method="POST">
                   ...
                   <div class="row mb-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name')is-invalid @enderror" placeholder="Nome do usuário" value="{{$user['name']}}" maxlength="50">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="permission" class="form-control @error('name')is-invalid @enderror">
                                ...
                                @foreach($roles as $role)
                                    @if($user['permission'] == $role->id)
                                        <option selected reandoly value="{{$user['permission']}}">Atual: {{$role->display_name}}</option>
                                    @endif
                   ...
                   <div class="row mb-3">
                       <div class="col mb-3">
                        ...
                        <input type="email" name="email" class="form-control @error('name')is-invalid @enderror" disabled placeholder="Digite o e-mail do usuário" value="{{$user['email']}}">
                       </div>
                   </div>
                   <div class="row mb-3">
                       <div class="col-md-6 mb-3">
                   ...
                   <div class="row mb-3">
                        <input type="submit" value="Atualizar usuário" class="col-md-12 btn btn-success">
                   </div>
